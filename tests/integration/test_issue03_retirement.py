...
def test_reminder_retirement_is_account_scoped_idempotent_and_clears_credentials(
    ...
    schedule_json = '{"first_run_at":"2026-08-09T00:00:00Z","repeat":"once","repeat_weekdays":null,"repeat_month_day":null,"timezone":"Asia/Shanghai"}'
    ...
    row = database.connection.execute(
        "SELECT status, next_run_at, next_retry_at FROM reminders WHERE reminder_id = 'rem-a'"
    ).fetchone()
