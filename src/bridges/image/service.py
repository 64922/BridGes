...
#: 稳定错误码 → 可操作中文提示（GQ-04：与主对话/语音同源；模型调用
#: 类稳定码以 ``bridges.ai.errors.MODEL_CALL_ERROR_MESSAGES_ZH`` 为唯一
#: 来源，本表只保留图片链路特有码；未命中的错误码回退网关原始消息，
