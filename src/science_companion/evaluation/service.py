...
def _build_digest() -> str:
    ...
    ``SCIENCE_COMPANION_BUILD_DIGEST`` override so tests can freeze it.
    """
    override = os.environ.get("SCIENCE_COMPANION_BUILD_DIGEST")
    if override:
        return override
    return f"science-companion@{package_version}"
...
class EvaluationService:
    ...
    def _build_reproduction_command(self, lock: EvaluationRunLock) -> str:
        return (
            f"science-companion evaluation replay "
